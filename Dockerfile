...
COPY --chown=user:user nnUNetTrainer_Xepochs.py /opt/algorithm/nnunet/nnUNet/nnunetv2/training/nnUNetTrainer/variants/training_length/nnUNetTrainer_Xepochs.py
